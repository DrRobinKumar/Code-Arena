 ...
 * Runs exactly once per request (OncePerRequestFilter) to avoid double
 * processing under async dispatches/forwards.
 */
@Component
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        final String username = safeExtractUsername(jwt);
    ...
    /** Malformed/expired tokens should fall through as "unauthenticated", not blow up the filter chain. */
